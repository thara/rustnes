...
pub(super) struct Register {
    ...
    pub(super) data: Byte,
    // OAMADDR
    pub(super) object_attribute_memory_address: Byte,
...
impl Register {
    ...
    pub fn is_enabled_sprite(&self, x: u16) -> bool {
    ...
    fn write_controller(&mut self, value: impl Into<u8>) {
...
impl Controller {
    ...
    fn base_name_table_addr(&self) -> Word {
    ...
    fn base_sprite_table_addr(&self) -> Word {
...
impl Status {
    // In vblank?
    const VBLANK: Self = Self(1 << 7);
    // Sprite 0 Hit
    const SPRITE_ZERO_HIT: Self = Self(1 << 6);
    // Sprite overflow
    const SPRITE_OVERFLOW: Self = Self(1 << 5);

    fn is_set(&self, Self(v): Self) -> bool {
        self.0 & v == v
    }
